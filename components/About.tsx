...
const Me = () => {
  ...
  return (
    <div className="overflow-hidden max-sm:-mt-20 max-sm:-mb-4 max-xs:-mt-28 max-xs:-mb-16">
      <div
        ref={container}
...
const About = (props: {}): JSX.Element => {
  ...
  const cardCommonClasses =
    'h-40 md:h-full p-2 md:p-4 shadow-md shadow-light/10 dark:shadow-black/10 bg-lightest dark:bg-dark rounded-4xl flex flex-col gap-2 fadeIn';
      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-4 px-2 sm:px-4 md:px-16 lg:px-[7.5rem] xl:px-36 2xl:max-w-7xl md:max-h-[63rem] lg:max-h-[60rem] xl:max-h-[51rem]">
        <div className="p-4 xs:p-5 md:p-6 lg:p-8 bg-lightest shadow-md shadow-light/10 dark:shadow-black/10 dark:bg-dark rounded-4xl flex flex-col gap-5 md:w-2/3">
          ...
          <h4 className="text-xl md:text-2xl">
            I&apos;m Ali, a passionate and creative individual who thrives on turning ideas into reality through his
            technical skills and knowledge.
          </h4>

          <p className="text-dark dark:text-lighter md:text-lg">
            My passion for self-learning, creation, and exploration drives me to constantly seek out new experiences and
            push the boundaries of my own potential. I am excited to embark on new adventures, collaborate with
            like-minded individuals and businesses, and contribute my unique perspectives and talents to the world
            around me.
          </p>
          ...
          <div className="mt-2 xl:mt-8">
            ...
            <ul className="flex flex-wrap mt-4 gap-[0.6rem]">
              {skills.map(skill => (
                <li
                  key={skill}
                  className="border-2 px-2 py-1 rounded-2xl border-light text-dark dark:text-lighter text-sm"
                >
                  {skill}
                </li>
              ))}
        ...
        <div
          ...
          className="grid grid-cols-3 md:grid-cols-none md:grid-rows-3 gap-2 md:gap-4 md:w-1/3"
        >
