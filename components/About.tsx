  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row gap-4 px-2 sm:px-4 md:px-16 lg:px-[7.5rem] xl:px-36 2xl:max-w-7xl">
        ...
        <div className="p-6 md:p-6 lg:p-8 bg-lightest shadow-md shadow-light/10 dark:bg-dark rounded-4xl flex flex-col gap-5 md:w-2/3">
        ...
        <div className="grid grid-cols-3 md:grid-cols-none md:grid-rows-3 gap-2 md:gap-4 md:max-h-[58.5rem] xl:max-h-[51rem] md:w-1/3">
          <div className="h-40 md:h-full p-2 md:p-4 shadow-md shadow-light/10 bg-lightest dark:bg-dark rounded-4xl flex flex-col gap-2">
