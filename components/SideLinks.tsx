      ...
      <div className="container relative mx-auto">
        <div className="absolute bottom-0 left-4 lg:left-8 flex flex-col items-center space-y-4">
          <Link
            ...
            className="text-xl border-[3px] border-solid border-light hover:border-lightest rounded-full p-[0.2rem] text-light hover:text-lightest transition-all duration-300 ease-in-out 
            hover:-translate-y-1"
          >
            <BiLogoGithub />
          </Link>
