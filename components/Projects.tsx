...
import byonTextile from '../public/projects/byon-textile.jpg';
...
const Projects = (props: {}): JSX.Element => {
  ...
  return (
    ...
    >
      <div
        ref={container}
        className="container mx-auto px-2 sm:px-4 md:px-16 lg:px-[7.5rem] xl:px-36 2xl:max-w-7xl"
      >
        <div className="text-center">
          <h1 className="fadeUp text-4xl md:text-5xl font-bold pb-4">Projects</h1>
          <p className="fadeUp text-xl sm:text-2xl md:text-3xl">
        ...
        <div className="mt-10 sm:mt-16 md:mt-20 flex flex-col gap-16 sm:gap-24 md:gap-28">
          <ProjectCard
            ...
            repoName="byon-textile"
            reverse
            badge="Freelance Project"
            title="Byon Textile"
            img={byonTextile}
            url="https://www.byontextile.com"
            content="A modern website for Byon Textile, built to present their custom sportswear and textile manufacturing services with clear product-focused messaging and a polished browsing experience."
          />
          ...
          <p className="-mt-4 text-center text-lg md:text-xl">
            See all of my work on{' '}
            <Link
              className="font-medium text-primary-light dark:text-secondary-dark"
              target="_blank"
              href={'https://Github.com/SydAliHsn'}
            >
              My Github <BiLogoGithub className="inline-block text-2xl" />
            </Link>
          </p>
        </div>
      </div>
